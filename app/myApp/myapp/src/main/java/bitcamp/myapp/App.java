...
public class App {
    ...
    static void printMenu() {
        ...
        System.out.println(boldAnsi + appTitle + redAnsi);
    ...
    static void processMenu(String menuTitle, String[] subMenus) {
        j.printSubMenu(menuTitle, mainMenus);
        while (true) {
            ...
            try {
                int menuNo = Integer.parseInt(command);
                String subMenuTitle = getMenuTitle(menuNo, mainMenus);
                if (subMenuTitle == null) {
                    System.out.println("유효한 메뉴 번호가 아닙ㄴ디ㅏ.");
                } else {
